...
> ### 📊 状态总览（2026-08-04 · 每轮验收更新此块）
>
> **93 个编号 = 正文 80 + 存根 4 + 归档 9。** 条目数是认知覆盖率，不是产品破损度——大多数条目是「读法纪律」（数据的脾气，永远不会"修好"），真正等 dev 的硬问题见下。
>
> **🔴 等 dev 的硬问题（速览，权威以正文为准）**
...
> · **部分修复待收尾**：N-38 硬顶仍在 · N-39 改名后仍不可当共识
>
