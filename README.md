...
| `Who is long SNDK` / `谁在做 SNDK` · `钱在挤哪` | [Live Position Diligence](./Live%20Positions/live-position-diligence.md) | Real-money perp positions + trader track record, with six gates (ghost-position filter first). **Not** a copy-trade ledger |
